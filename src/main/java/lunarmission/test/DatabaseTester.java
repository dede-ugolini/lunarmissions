...
public class DatabaseTester {
	...
	//Testando as conversoes de Object para Document, tendo compatibilidade com o Nitrite
	public void testDocumentMapper() {
		...
		Mission missao2 = DocumentMapper.toObject(content, Mission.class); ///Criando Object atraves de document
		
		Document docMissao2 = DocumentMapper.toDocument(missao2); //Criando o docMissao
	}
